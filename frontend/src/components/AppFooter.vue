<template>
  <footer class="py-16" style="background: linear-gradient(45deg, #00555d, #091e27);">
      ...
      <div class="grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2 text-white/70">
            <li><a href="#" class="hover:text-white transition-colors">PIX</a></li>
            <li><a href="#" class="hover:text-white transition-colors">Checkouts</a></li>
